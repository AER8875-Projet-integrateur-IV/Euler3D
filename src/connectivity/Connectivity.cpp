...
void SolveNode2element(int element2nodeStart[], int element2node[], int nElem, int nNode){
...
void SolveElement2Element(int nElem, int element2node[], int element2nodeStart[], int nNode, int node2element[], int node2elementStart[], int VTK[], std::vector<int> nFacefElement, std::vector<std::vector<int>> nNodefFace){
          ...
          if (jelem != ielem) {
            ...
            for (size_t jface = 0; jface < nLocaleFacesJ; jface++) {
              ...
              if (nLocalNodefFaceI == nNodeForFaceJ) {
                int count = 0;
                GetNodeIndices(jface, jelem, nLocaleFacesJ, VTK[jelem]);
                int sortie[]; //sortie de GetNodeIndices a implementer sous forme de pointeurs
                for (size_t JlocalNode = 0; JlocalNode < nNodeForFaceJ; JlocalNode++) {
                  int pointIndex = startJ + sortie[JlocalNode];
...
void GetNodeIndices(int face, int jelem, int nLocalFacefElement, int VTK){
...
void ComputeVTKLinkedLists(int VTK[], int nElem){
