...
namespace E3D
{
    ...
    struct Mesh {
        ...
        /**
         * @return Element 2 element connectivity
         */
        inline const std::vector<int> &GetElement2Element() const
        {
            return _elem2elem;
        }
        /**
         * @return Element 2 element connectivity start
         */
        inline const std::vector<int> &GetElement2ElementStart() const
        {
            return _elem2elemStart;
        }

    private:
        Parser::SU2MeshParser _parser;
        std::vector<int> _elem2elemStart;
        std::vector<int> _elem2elem;
    };
